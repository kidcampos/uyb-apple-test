...
const NavigationBar = props => {
	...
	return (
		<>
			<nav id="globalnav" lang="en-US" dir="ltr"  style={{"--r-globalnav-text-zoom-scale": '1'}}>

			{/* <div className="globalnav-content">
				<div className="globalnav-item globalnav-menuback"><button aria-label="Main menu"
						className="globalnav-menuback-button"><span className="globalnav-chevron-icon"><svg height="48"
								viewBox="0 0 9 48" width="9" xmlns="http://www.w3.org/2000/svg">
								<path
				...
				<ul id="globalnav-list" className="globalnav-list">
					<li data-analytics-element-engagement="globalnav hover - apple" className="
				globalnav-item
				globalnav-item-apple
				
				
			">
                <a href="https://www.apple.com/" data-globalnav-item-name="apple" data-analytics-title="apple home"
							aria-label="Apple" className="globalnav-link globalnav-link-apple"><span
								className="globalnav-image-regular globalnav-link-image"><svg height="44"
								...
								</svg></span><span className="globalnav-image-compact globalnav-link-image"><svg height="48"
								...
								</svg></span><span className="globalnav-link-text">Apple</span></a></li>
					<li data-topnav-flyout-item="menu" data-topnav-flyout-label="Menu"
						...
						<div data-topnav-flyout="menu" className="globalnav-flyout"
							...
							<div className="globalnav-menu-list" style="--r-globalnav-flyout-item-total: 11;">
								<div data-analytics-element-engagement="globalnav hover - store" className="
				globalnav-item
			...
			" style="--r-globalnav-flyout-item-number: 0;">
									...
									<div id="globalnav-submenu-link-store" className="globalnav-flyout globalnav-submenu"
										...
										<div className="globalnav-flyout-scroll-container">
											<div className="globalnav-flyout-content globalnav-submenu-content"
												...
												<div className="globalnav-submenu-group globalnav-submenu-group-elevated"
													...
													<h2 className="globalnav-submenu-header" id="c64e0a00"
													...
													<ul className="globalnav-submenu-list" aria-labelledby="c64e0a00">
														<li className="globalnav-submenu-list-item-elevated"
															style="--r-globalnav-flyout-item-number: 2;"><a
																...
																aria-label="Shop the latest Apple products">Shop the
																Latest</a></li>
														<li className="globalnav-submenu-list-item-elevated"
														...
														<li className="globalnav-submenu-list-item-elevated"
															style="--r-globalnav-flyout-item-number: 6;"><a
																...
																className="globalnav-submenu-link"
																data-analytics-title="apple watch">Apple Watch</a></li>
														<li className="globalnav-submenu-list-item-elevated"
												...
												<div className="globalnav-submenu-group "
													...
													<h2 className="globalnav-submenu-header" id="1c90bcf2"
														style="--r-globalnav-flyout-item-number: 1;">Quick Links</h2>
													<ul className="globalnav-submenu-list" aria-labelledby="1c90bcf2">
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 2;"><a
																...
																className="globalnav-submenu-link"
																data-analytics-title="find a store">Find a Store</a>
														</li>
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 3;"><a
																href="https://www.apple.com/us/shop/goto/order/list"
																className="globalnav-submenu-link"
																data-analytics-title="order status">Order Status</a>
														</li>
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 4;"><a
												...
												<div className="globalnav-submenu-group "
													...
													<h2 className="globalnav-submenu-header" id="68805228"
														style="--r-globalnav-flyout-item-number: 1;">Shop Special Stores
													</h2>
													<ul className="globalnav-submenu-list" aria-labelledby="68805228">
														...
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 4;"><a
																...
																className="globalnav-submenu-link"
																data-analytics-title="business">Business</a></li>
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 5;"><a
														...
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 6;"><a
																...
																className="globalnav-submenu-link"
																data-analytics-title="government">Government</a></li>
													</ul>
												</div>
											</div>
										</div>
								...
								<div data-analytics-element-engagement="globalnav hover - mac" className="
				globalnav-item
				globalnav-item-mac
				globalnav-item-menu
				globalnav-item-submenu
			" style="--r-globalnav-flyout-item-number: 1;">
									<ul className="globalnav-submenu-trigger-group">
										<li className="globalnav-submenu-trigger-item"><a href="https://www.apple.com/mac/"
												data-globalnav-item-name="mac" data-topnav-flyout-trigger-compact=""
												data-analytics-title="mac"
												data-analytics-element-engagement="hover - mac" aria-label="Mac"
												className="globalnav-link globalnav-submenu-trigger-link globalnav-link-mac"><span
													className="globalnav-link-text-container"><span
														className="globalnav-image-regular globalnav-link-image"><svg
									...
									<div id="globalnav-submenu-link-mac" className="globalnav-flyout globalnav-submenu"
										...
										<div className="globalnav-flyout-scroll-container">
											<div className="globalnav-flyout-content globalnav-submenu-content"
												...
												<div className="globalnav-submenu-group globalnav-submenu-group-elevated"
													...
													style="--r-globalnav-flyout-group-number: 0;">
													<h2 className="globalnav-submenu-header" id="5d48857a"
														style="--r-globalnav-flyout-item-number: 1;">Explore Mac</h2>
													<ul className="globalnav-submenu-list" aria-labelledby="5d48857a">
														<li className="globalnav-submenu-list-item-elevated"
															style="--r-globalnav-flyout-item-number: 2;"><a
																href="https://www.apple.com/mac/"
																className="globalnav-submenu-link"
																data-analytics-title="explore all mac">Explore All
																Mac</a></li>
														<li className="globalnav-submenu-list-item-elevated"
															style="--r-globalnav-flyout-item-number: 3;"><a
																href="https://www.apple.com/macbook-air/"
																className="globalnav-submenu-link"
																data-analytics-title="macbook air">MacBook Air</a></li>
														<li className="globalnav-submenu-list-item-elevated"
															style="--r-globalnav-flyout-item-number: 4;"><a
																href="https://www.apple.com/macbook-pro/"
																className="globalnav-submenu-link"
																data-analytics-title="macbook pro">MacBook Pro</a></li>
														<li className="globalnav-submenu-list-item-elevated"
															style="--r-globalnav-flyout-item-number: 5;"><a
																href="https://www.apple.com/imac/"
																className="globalnav-submenu-link"
																data-analytics-title="imac" aria-label="iMac">iMac</a>
														</li>
														<li className="globalnav-submenu-list-item-elevated"
															style="--r-globalnav-flyout-item-number: 6;"><a
																href="https://www.apple.com/mac-mini/"
																className="globalnav-submenu-link"
																data-analytics-title="mac mini">Mac mini</a></li>
														<li className="globalnav-submenu-list-item-elevated"
															style="--r-globalnav-flyout-item-number: 7;"><a
																href="https://www.apple.com/mac-studio/"
																className="globalnav-submenu-link"
																data-analytics-title="mac studio">Mac Studio</a></li>
														<li className="globalnav-submenu-list-item-elevated"
														...
														<li className="globalnav-submenu-list-item-elevated"
															style="--r-globalnav-flyout-item-number: 9;"><a
																...
																className="globalnav-submenu-link"
																data-analytics-title="displays">Displays</a></li>
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 10;"><a
																href="https://www.apple.com/mac/compare/"
																className="globalnav-submenu-link"
																data-analytics-title="compare mac">Compare Mac</a></li>
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 11;"><a
																href="https://www.apple.com/mac/mac-does-that/"
																className="globalnav-submenu-link"
																data-analytics-title="mac does that">Mac Does That</a>
														</li>
													</ul>
												</div>
												<div className="globalnav-submenu-group " data-analytics-region="shop mac"
													style="--r-globalnav-flyout-group-number: 1;">
													<h2 className="globalnav-submenu-header" id="62dd6e22"
														style="--r-globalnav-flyout-item-number: 1;">Shop Mac</h2>
													<ul className="globalnav-submenu-list" aria-labelledby="62dd6e22">
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 2;"><a
																href="https://www.apple.com/us/shop/goto/buy_mac"
																className="globalnav-submenu-link"
																data-analytics-title="shop mac">Shop Mac</a></li>
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 3;"><a
												...
												<div className="globalnav-submenu-group "
													...
													style="--r-globalnav-flyout-group-number: 2;">
													<h2 className="globalnav-submenu-header" id="bb641a58"
														style="--r-globalnav-flyout-item-number: 1;">More from Mac</h2>
													<ul className="globalnav-submenu-list" aria-labelledby="bb641a58">
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 2;"><a
																...
																data-analytics-title="mac support">Mac Support</a></li>
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 3;"><a
																href="https://www.apple.com/support/products/mac/"
																className="globalnav-submenu-link"
																data-analytics-title="applecare+ for mac">AppleCare+ for
																Mac</a></li>
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 4;"><a
																href="https://www.apple.com/macos/sonoma/"
																className="globalnav-submenu-link"
																data-analytics-title="macos sonoma">macOS Sonoma</a>
														</li>
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 5;"><a
														...
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 6;"><a
																...
																className="globalnav-submenu-link"
																data-analytics-title="continuity">Continuity</a></li>
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 7;"><a
								...
								<div data-analytics-element-engagement="globalnav hover - ipad" className="
				globalnav-item
				globalnav-item-ipad
				globalnav-item-menu
				globalnav-item-submenu
			" style="--r-globalnav-flyout-item-number: 2;">
									<ul className="globalnav-submenu-trigger-group">
										<li className="globalnav-submenu-trigger-item"><a href="https://www.apple.com/ipad/"
												data-globalnav-item-name="ipad" data-topnav-flyout-trigger-compact=""
												data-analytics-title="ipad"
												data-analytics-element-engagement="hover - ipad" aria-label="iPad"
												className="globalnav-link globalnav-submenu-trigger-link globalnav-link-ipad"><span
													className="globalnav-link-text-container"><span
														className="globalnav-image-regular globalnav-link-image"><svg
															height="44" viewBox="0 0 24 44" width="24"
															xmlns="http://www.w3.org/2000/svg">
															<path
														...
														className="globalnav-link-text">iPad</span></span><span
													className="globalnav-link-chevron"><svg height="48" viewBox="0 0 9 48"
														width="9" xmlns="http://www.w3.org/2000/svg">
														<path
															d="m8.1155 30.358a.6.6 0 1 1 -.831.8653l-7-6.7242a.6.6 0 0 1 -.0045-.8613l7-6.8569a.6.6 0 1 1 .84.8574l-6.5582 6.4238z">
									...
									<div id="globalnav-submenu-link-ipad" className="globalnav-flyout globalnav-submenu"
										...
										<div className="globalnav-flyout-scroll-container">
											<div className="globalnav-flyout-content globalnav-submenu-content"
												...
												<div className="globalnav-submenu-group globalnav-submenu-group-elevated"
													...
													style="--r-globalnav-flyout-group-number: 0;">
													<h2 className="globalnav-submenu-header" id="47cb20e0"
														style="--r-globalnav-flyout-item-number: 1;">Explore iPad</h2>
													<ul className="globalnav-submenu-list" aria-labelledby="47cb20e0">
														<li className="globalnav-submenu-list-item-elevated"
															style="--r-globalnav-flyout-item-number: 2;"><a
																href="https://www.apple.com/ipad/"
																className="globalnav-submenu-link"
																data-analytics-title="explore all ipad">Explore All
																iPad</a></li>
														<li className="globalnav-submenu-list-item-elevated"
															style="--r-globalnav-flyout-item-number: 3;"><a
																href="https://www.apple.com/ipad-pro/"
																className="globalnav-submenu-link"
																data-analytics-title="ipad pro">iPad Pro</a></li>
														<li className="globalnav-submenu-list-item-elevated"
															style="--r-globalnav-flyout-item-number: 4;"><a
																href="https://www.apple.com/ipad-air/"
																className="globalnav-submenu-link"
																data-analytics-title="ipad air">iPad Air</a></li>
														<li className="globalnav-submenu-list-item-elevated"
															style="--r-globalnav-flyout-item-number: 5;"><a
																href="https://www.apple.com/ipad-select/"
																className="globalnav-submenu-link"
																data-analytics-title="ipad"
																aria-label="iPad 10.2">iPad</a></li>
														<li className="globalnav-submenu-list-item-elevated"
															style="--r-globalnav-flyout-item-number: 6;"><a
																href="https://www.apple.com/ipad-mini/"
																className="globalnav-submenu-link"
																data-analytics-title="ipad mini">iPad mini</a></li>
														<li className="globalnav-submenu-list-item-elevated"
															style="--r-globalnav-flyout-item-number: 7;"><a
																href="https://www.apple.com/apple-pencil/"
																className="globalnav-submenu-link"
																data-analytics-title="apple pencil">Apple Pencil</a>
														</li>
														<li className="globalnav-submenu-list-item-elevated"
															style="--r-globalnav-flyout-item-number: 8;"><a
																href="https://www.apple.com/ipad-keyboards/"
																className="globalnav-submenu-link"
																data-analytics-title="keyboards">Keyboards</a></li>
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 9;"><a
																href="https://www.apple.com/ipad/compare/"
																className="globalnav-submenu-link"
																data-analytics-title="compare ipad">Compare iPad</a>
														</li>
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 10;"><a
																href="https://www.apple.com/ipad/why-ipad/"
																className="globalnav-submenu-link"
																data-analytics-title="why ipad">Why iPad</a></li>
													</ul>
												</div>
												<div className="globalnav-submenu-group " data-analytics-region="shop ipad"
													style="--r-globalnav-flyout-group-number: 1;">
													<h2 className="globalnav-submenu-header" id="4b8deaa6"
														style="--r-globalnav-flyout-item-number: 1;">Shop iPad</h2>
													<ul className="globalnav-submenu-list" aria-labelledby="4b8deaa6">
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 2;"><a
																href="https://www.apple.com/us/shop/goto/buy_ipad"
																className="globalnav-submenu-link"
																data-analytics-title="shop ipad">Shop iPad</a></li>
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 3;"><a
												...
												<div className="globalnav-submenu-group "
													...
													style="--r-globalnav-flyout-group-number: 2;">
													<h2 className="globalnav-submenu-header" id="94a048ee"
														style="--r-globalnav-flyout-item-number: 1;">More from iPad</h2>
													<ul className="globalnav-submenu-list" aria-labelledby="94a048ee">
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 2;"><a
																href="https://support.apple.com/ipad?cid=gn-ols-ipad-psp-prodfly"
																className="globalnav-submenu-link"
																data-analytics-title="ipados support"
																data-analytics-exit-link="true">iPad Support</a></li>
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 3;"><a
																href="https://www.apple.com/support/products/ipad/"
																className="globalnav-submenu-link"
																data-analytics-title="applecare+ for ipad">AppleCare+
																for iPad</a></li>
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 4;"><a
																href="https://www.apple.com/ipados/ipados-17/"
																className="globalnav-submenu-link"
																data-analytics-title="ipados 17">iPadOS 17</a></li>
														<li className="globalnav-submenu-list-item"
															style="--r-globalnav-flyout-item-number: 5;"><a
																href="https://www.apple.com/apps/"
																className="globalnav-submenu-link"
								...
								<div data-analytics-element-engagement="globalnav hover - iphone" className="
				globalnav-item
			...
			" style="--r-globalnav-flyout-item-number: 3;">
								...
								<div data-analytics-element-engagement="globalnav hover - watch" className="
				globalnav-item
			...
			" style="--r-globalnav-flyout-item-number: 4;">
								...
								<div data-analytics-element-engagement="globalnav hover - vision" className="
				globalnav-item
			...
			" style="--r-globalnav-flyout-item-number: 5;">
								...
								<div data-analytics-element-engagement="globalnav hover - airpods" className="
				globalnav-item
			...
			" style="--r-globalnav-flyout-item-number: 6;">
								...
								<div data-analytics-element-engagement="globalnav hover - tv-home" className="
				globalnav-item
			...
			" style="--r-globalnav-flyout-item-number: 7;">
								...
								<div data-analytics-element-engagement="globalnav hover - entertainment" className="
				globalnav-item
			...
			" style="--r-globalnav-flyout-item-number: 8;">
								...
								<div data-analytics-element-engagement="globalnav hover - accessories" className="
				globalnav-item
			...
			" style="--r-globalnav-flyout-item-number: 9;">
								...
								<div data-analytics-element-engagement="globalnav hover - support" className="
				globalnav-item
			...
			" style="--r-globalnav-flyout-item-number: 10;">
				...
				<div className="globalnav-menutrigger"><button id="globalnav-menutrigger-button"
						aria-controls="globalnav-list" aria-label="Menu" data-topnav-menu-label-open="Menu"
						data-topnav-menu-label-close="Close" data-topnav-flyout-trigger-compact="menu"
						className="globalnav-menutrigger-button"><svg width="18" height="18" viewBox="0 0 18 18">
							<polyline id="globalnav-menutrigger-bread-bottom" fill="none" stroke="currentColor"
								strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" points="2 12, 16 12"
							...
							<polyline id="globalnav-menutrigger-bread-top" fill="none" stroke="currentColor"
								strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" points="2 5, 16 5"
